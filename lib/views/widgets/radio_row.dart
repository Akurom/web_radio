      ...
      child: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(padding: EdgeInsets.only(left: screenHeight(context) * SizeConstants.defaultPaddingRatio*2)),

            Expanded(child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Flexible(
                    child: Text(radio.name, overflow: TextOverflow.ellipsis, style: Theme.of(context).textTheme.bodyLarge)),
                Flexible(
                    child: Text(radio.tags, overflow: TextOverflow.ellipsis,
                        style: Theme.of(context).textTheme.bodyMedium!.copyWith(color: ColorConstants.primaryLightColor))),
              ],
            ),),
